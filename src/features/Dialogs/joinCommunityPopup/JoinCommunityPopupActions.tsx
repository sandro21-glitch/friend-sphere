  ...
  return (
    <div className="flex gap-5">
      ...
      <button
        ...
        className="bg-white border border-gray-400 hover:bg-gray-100 transition-colors ease-in duration-150 text-gray-600 px-4 py-1 text-[14px] rounded-md"
      >
        Cancel
      </button>
      <button
        ...
        className="bg-azure-blue hover:bg-deep-blue transition-colors ease-in duration-150
         text-white px-4 py-1 text-[14px] font-semibold rounded-md"
      >
        {loading ? (
          <div role="status">
            <span className="mr-1">Joining...</span>
            <svg
              aria-hidden="true"
